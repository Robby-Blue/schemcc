...
function countBlocks(building)
	length = building.length
	height = building.height
	width = building.width

	local blocks = building.blocks
	for key, block in pairs(blocks) do
		countBlock(block.material)
	end
end

function countBlock(material)
	for key, block in pairs(blockcount) do
		if block.material == material then
...
function drawScreen()
	...
	print("Materials:")
	for key, block in pairs(blockcount) do
		print(" - " .. block.material .. ": " .. block.count)
	end
end
